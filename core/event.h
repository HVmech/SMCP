...
typedef enum { // Перечислитель событий
    ...
    EVENT_MOTOR_TELEMETRY_UPDATE,
    EVENT_MOTOR_RECOVERY_REQUEST,
    EVENT_MOTOR_RECOVERY_COMPLETE,
    EVENT_STATE_TRANSITION_REQUEST,
    EVENT_INPUT_ERROR_DISCARD,
    EVENT_LCD_UPDATE_REQUEST,
    EVENT_TYPES_NUM
} event_id_t;
