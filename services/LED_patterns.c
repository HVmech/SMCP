...
static const LED_command_t heartbeat_seq[] = {
...
const LED_pattern_t LED_pattern_heartbeat = {
...
static const LED_command_t sos_seq[] = {
    // S: · · ·
...
const LED_pattern_t LED_pattern_SOS = {
    .arr_cmd_seq = sos_seq,
